    ...
    <>
      ...
      <main>
        ...
        <section className="hero-inside transparent">
          <div className="auto-container">
            <h2 className="hero-title">Terms of Use</h2>
          </div>
        </section>
          ...
          <div className="auto-container">
            <div className="terms-container">
              ...
              <p>
                ...
                to you for your acceptance when<br />
              ...
              <p><strong>THESE TERMS STATE THAT ANY DISPUTES BETWEEN YOU AND RIDGECREST MUST BE RESOLVED IN BINDING
                  ARBITRATION, THAT YOU WAIVE THE RIGHT TO PARTICIPATE IN ANY CLASS ACTION, AND THAT THE LAW OF THE STATE OF
                </strong><strong>UTAH APPLIES TO ALL INTERACTIONS BETWEEN YOU AND RIDGECREST. YOU MAY OPT OUT OF ARBITRATION
                  AND THE CLASS ACTION WAIVER BY FOLLOWING THE PROCEDURES IN SECTION 10.G BELOW </strong></p>
              <p>
                <strong>1.&nbsp;Description of Services</strong><br />
              ...
              <p>
                a. <strong>Marketplace Services</strong><br />
                ...
                prepare for and acquire a business loan.<br />
                b. <strong>Other miscellaneous services</strong><br />
                Ridgecrest may add additional products and services over time, and these Terms of Use shall apply to those
                additional services.
              </p>
              <p>
                <strong>2. Use of Site and Service:</strong><br />
                As a user of the Site or a user registered to use any of the Services (a &quot;Registered User&quot;), you agree to
                the following:<br />
                a. <strong>Exclusive Use.</strong> Your account is to be used only by you and only for your business needs.
                ...
                your account that results from theft or misappropriation of your user name and passwords.<br />
                b. <strong>Information Submitted.</strong> You are solely responsible for, and assume all liability
                ...
                rejected and your account will be put on hold.<br />
                c. <strong>Risk Assumption and Precautions.</strong> You assume all risk when using the Services, including
                but not limited to all of the risks associated with any interactions with third-parties, including but not
                limited to any lenders to which you are matched, referred or provided.<br />
                d. <strong>No Guarantees.</strong> Ridgecrest may not be able to provide matches for every individual or
                business seeking to use the Services. Ridgecrest makes no guarantees as to the number of matches or the
                suitability of the business funding for any individual or business which utilizes the Services.<br />
                e. <strong>No False Information.</strong> You agree to provide accurate, true, current and complete
                ...
                Services.<br />
                f. <strong>Legal Purpose.</strong> You agree to not use the Site or Services for any illegal purpose. You
                will only use the Site or Service in accordance with federal, state and local laws.<br />
                g. <strong>Business Purpose.</strong> You agree to only use the Site or Services for a bona fide business
              ...
              <p>
                <strong>3. Intellectual Property Rights:<br /> </strong>&nbsp; &nbsp; &nbsp;a. <strong>Ownership of
                  Proprietary Information.</strong> You hereby acknowledge and agree that Ridgecrest is the owner of all
                ...
                reverse engineer or reverse compile any of the Site or Services or technology.<br />
                b. <strong>No Use of Confidential Information.</strong> You will not post, copy, modify, transmit, disclose,
                ...
                owner of such proprietary rights.<br />
                c. <strong>License to Provided Content.</strong> By providing information or content to any account or
              ...
              <p>
                <strong>4. Links to Third Party Websites and Dealings with Advertisers and Sponsors:</strong><br />
                ...
                Please visit our
                <Link href="/privacy-policy"> Privacy Policy</Link> to learn more about how we use your
                information.
              </p>
              <p>
                <strong>5. Disclaimer of Warranty:</strong><br />
                ...
                OR RELIABILITY OF ANY OPINION, ADVICE, OR STATEMENT MADE BY ANY PARTY OTHER<br />
              ...
              <p>
                You agree to indemnify, defend and hold harmless Ridgecrest, its officers, directors, employees, agents and
                third parties, for any losses, costs, liabilities and expenses (including reasonable attorneys&apos; fees)
                relating to or arising out of (i) your use of or inability to use the Site or Services, (ii) any user
                postings made by you, (iii) your violation of any terms of these Terms or your violation of any rights of a
                third-party, or (iv) your violation of any applicable laws, rules
                or regulations. Ridgecrest reserves the right, at its own cost, to assume the exclusive defense and control
                of any matter otherwise subject to indemnification by you, in which event you will fully cooperate with
                Ridgecrest in asserting any available defenses
              </p>
              <p><strong>8. User Information:</strong></p>
              <p>
                ...
                Services, you are consenting to the terms of Ridgecrest&apos;s Privacy Policy.<br />
                ...
                Ridgecrest&apos;s, or a third-party&apos;s, rights or property.<br />
                c. Information Security. We work hard to protect Ridgecrest and our users from unauthorized access to or
                unauthorized alteration, disclosure or destruction of information we hold. In particular:<br />
                i. We encrypt many of our services using industry standard methods.<br />
                ii. We review our information collection, storage and processing practices, including physical security
                measures, to guard against unauthorized access to systems.<br />
                ...
                Ridgecrest&apos;s research into successful business practices and to improve the Services.<br />
              ...
              <p>
                <strong>9. Restrictions:</strong><br />
              ...
              <p>
                <strong>10.Dispute Resolution by Binding Arbitration:</strong><br />
              ...
              <p>
                ...
                claims that may arise after the termination of these Terms.<br />
              ...
              <p>
                ...
                and upon request from either party made within 14 days of the arbitrator&apos;s ruling on the<br />
                merits.
              </p>
              <p>No Class Actions. Unless both you and Ridgecrest agree otherwise, the arbitrator may not consolidate more
                than one person&apos;s claims, and may not otherwise preside over any form of a representative or class
                proceeding.</p>
              <p>YOU AND RIDGECREST AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL
                CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING:</p>
              <p>
                ...
                arbitration agreements that you may have with Ridgecrest.<br />
              ...
              <p>11. Telephone communications and agreement to be contacted:</p>
              <p>
                ...
                <a href="mailto:admin@ridgecrestfg.com">admin@ridgecrestfg.com</a>.<br />
                ...
                you do not consent, you may call us at 1-800-546-2190 or via email to <a href="mailto:admin@ridgecrestfg.com">admin@ridgecrestfg.com</a> to further inquire about
                our products and services. To opt-out, please see the Opt-Out Instructions below.<br />
                ...
                shortcode to which you would like to unsubscribe. Alternatively, you may <a href="mailto:admin@ridgecrestfg.com">admin@ridgecrestfg.com</a> advising that you want to opt out of
                ...
                and (iii) send this written notice to <a href="mailto:admin@ridgecrestfg.com">admin@ridgecrestfg.com</a>. It is your sole responsibility to
                ...
                directly to inform them of your communication preferences.<br />
                ...
                Ridgecrest is not responsible for such charges.<br />
                ...
                have the exclusive right to choose counsel, at your expense, to defend any such claims.<br />
                ...
                statutes, and any federal or state tort or consumer protection laws).<br />
                ...
                obligations under this Section will survive termination of these Terms of Service.<br />
                i. Text message Terms and Conditions:<br />
                <strong>By &quot;Opting In&quot; to or using a Ridgecrest Text Message Service (&quot;SMS Service&quot;), you accept these Terms
                  ...
                  Ridgecrest&apos;s Terms of Use.</strong><br />
                ...
                of that number on a family or business plan and that you are authorized to Opt-In.<br />
                ...
                again, just sign up as you did the first time and we will start sending SMS messages to you again.<br />
                m. If you are experiencing issues with the messaging program you can reply with the keyword HELP for more
                assistance, or you can get help directly at <a href="mailto:admin@ridgecrestfg.com">admin@ridgecrestfg.com</a> or 1-800-546-2190.<br />
                n. Carriers are not liable for delayed or undelivered messages<br />
                ...
                best to contact your wireless provider.<br />
                p. If you have any questions regarding privacy, please read our privacy policy: <a href="https://ridgecrestfg.com/privacy-policy/">https://ridgecrestfg.com/privacy-policy/</a>
              </p>
              <p>
              ...
              <p>
                15.Notification of Terms of Use Changes:<br />
