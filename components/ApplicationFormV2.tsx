            ...
            <div className="gfield gfield--type-text gfield--width-half">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="legalName"
                  className={errors.legalName ? "large inputError" : "large"}
              ...
              <div className="ginput_container ginput_container_address">
                <div style={{width: '100%', marginBottom: '16px'}}>
                  <input
                    type="text"
                    id="businessAddress"
                    className={errors.businessAddress ? "large inputError" : "large"}
                ...
                <div style={{display: 'flex', gap: '16px', marginBottom: '16px'}}>
                  <div style={{flex: 1}}>
                    <input
                      type="text"
                      id="businessCity"
                      className={errors.businessCity ? "large inputError" : "large"}
                ...
                <div style={{width: '50%'}}>
                  <input
                    type="text"
                    id="businessZip"
                    className={errors.businessZip ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-half">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="ein"
                  className={errors.ein ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-full">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="owner1Name"
                  className={errors.owner1Name ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-full">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="owner1Address"
                  className={errors.owner1Address ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-half">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="owner1City"
                  className={errors.owner1City ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-half">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="owner1State"
                  className={errors.owner1State ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-half">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="owner1Zip"
                  className={errors.owner1Zip ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-half">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="owner1Ownership"
                  className={errors.owner1Ownership ? "large inputError" : "large"}
            ...
            <div className="gfield gfield--type-text gfield--width-half">
              ...
              <div className="ginput_container ginput_container_text">
                <input
                  type="text"
                  id="owner1Ssn"
                  className={errors.owner1Ssn ? "large inputError" : "large"}
