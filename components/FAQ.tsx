          ...
          <div className="faq__content">
            <div className="accordion-section">
              <h3 className={`accordion-header ${openIndex === 0 ? 'active' : ''}`} onClick={() => toggleAccordion(0)} style={{ cursor: 'pointer' }}>
                Who is Ridgecrest Financial Group?
              </h3>
              <div className={`accordion-content ${openIndex === 0 ? 'open' : ''}`}>
                <p>
                  Ridgecrest Financial Group is a leading provider of specialized financial solutions designed to help small and medium-sized businesses reach their full potential.
                </p>
              </div>
            </div>
            <div className="accordion-section">
              <h3 className={`accordion-header ${openIndex === 1 ? 'active' : ''}`} onClick={() => toggleAccordion(1)} style={{ cursor: 'pointer' }}>
                What financial solutions does Ridgecrest Financial offer?
              </h3>
              <div className={`accordion-content ${openIndex === 1 ? 'open' : ''}`}>
                <p>
                  Ridgecrest Financial offers flexible term loans, lines of credit, and creative, customized financing solutions tailored to your business needs.
                </p>
              </div>
            </div>
            <div className="accordion-section">
              ...
              <div className={`accordion-content ${openIndex === 2 ? 'open' : ''}`}>
                <p>
                  No, Ridgecrest Financial Group offers unsecured loans. In specific cases, RCFG may secure our loans with a general lien on your business assets and a personal guarantee. Rest assured, your personal assets are not used as collateral.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="faq__content">
            <div className="accordion-section">
              <h3 className={`accordion-header ${openIndex === 3 ? 'active' : ''}`} onClick={() => toggleAccordion(3)} style={{ cursor: 'pointer' }}>
                How can Ridgecrest Financial help my business?
              </h3>
              <div className={`accordion-content ${openIndex === 3 ? 'open' : ''}`}>
                <p>
                  Ridgecrest Financial Group provides customized financing options, including flexible loans and lines of credit tailored to your needs. With expert guidance and continuous support, we help your business thrive and succeed.
                </p>
              </div>
            </div>
            <div className="accordion-section">
              ...
              <div className={`accordion-content ${openIndex === 4 ? 'open' : ''}`}>
                <p>
                  Ridgecrest Financial Group allows flexibility in the use of funds, provided they are for legitimate business purposes.
                </p>
              </div>
            </div>
            <div className="accordion-section">
