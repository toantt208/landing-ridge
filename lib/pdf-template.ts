...
export function generatePDFTemplate(data: ApplicationData): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  <div class="disclaimer">
    Please complete this application and return with 6 months bank statements to receive a formal funding approval. There are no fees, charges or obligations associated with obtaining a pre-approval. Pre-approval does not constitute a funding commitment.
  </div>

  <!-- A. BUSINESS INFORMATION -->
  <div class="section-header">A. BUSINESS INFORMATION</div>
  <table>
    <tr>
      <td><strong>Business Legal Name:</strong><br>${data.legalName || ''}</td>
      <td><strong>Business DBA Name:</strong><br>${data.dbaName || ''}</td>
    </tr>
    <tr>
      <td><strong>Street Address:</strong><br>${data.businessAddress || ''}</td>
      <td><strong>City:</strong><br>${data.businessCity || ''}</td>
    </tr>
    <tr>
      <td style="padding: 0; border: 1px solid #37008F;">
        <table style="width: 100%; border: none; border-collapse: collapse;">
          <tr>
            <td style="border: none; border-right: 1px solid #37008F; padding: 8px 10px; width: 50%;"><strong>State:</strong> ${data.businessState || ''}</td>
            <td style="border: none; padding: 8px 10px; width: 50%;"><strong>Zip:</strong> ${data.businessZip || ''}</td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td><strong>Product / Service Sold:</strong><br>${data.productService || ''}</td>
    ...
    <tr>
      <td>
        ...
        <span style="display: inline-block; margin-left: 10px;">
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.partnership === 'Corp' ? '✓' : ''}</span> Corp
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-left: 10px; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.partnership === 'Sole Prop' ? '✓' : ''}</span> Sole Prop
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-left: 10px; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.partnership === 'LLC' ? '✓' : ''}</span> LLC
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-left: 10px; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.partnership === 'Partnership' ? '✓' : ''}</span> Partnership
        </span>
      </td>
    ...
    <tr>
      <td>
        ...
        <span style="display: inline-block; margin-left: 10px;">
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.businessType === 'Store Front' ? '✓' : ''}</span> Store Front
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-left: 10px; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.businessType === 'Office' ? '✓' : ''}</span> Office
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-left: 10px; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.businessType === 'Home' ? '✓' : ''}</span> Home
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-left: 10px; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.businessType === 'Other' ? '✓' : ''}</span> Other
        </span>
      </td>
      <td><strong>Email:</strong><br>${data.email || ''}</td>
    </tr>
    <tr>
      <td><strong>Date Business Started:</strong><br>${data.dateStarted || ''}</td>
      <td><strong>Federal State Tax #:</strong><br>${data.ein || ''}</td>
    </tr>
  </table>
  ...
  <table class="two-col-table">
    <tr>
      <td class="owner-header">B. OWNER/PRINCIPLE INFORMATION</td>
      <td class="owner-header">OWNER #2 (IF APPLICABLE)</td>
    </tr>
    <tr>
      <td><strong>Name:</strong> ${data.owner1Name || ''}</td>
      <td><strong>Name:</strong> ${data.owner2Name || ''}</td>
    </tr>
    <tr>
      <td><strong>Address:</strong> ${data.owner1Address || ''}</td>
      <td><strong>Address:</strong> ${data.owner2Address || ''}</td>
    </tr>
    <tr>
      <td><strong>City, State Zip:</strong> ${data.owner1City || ''}, ${data.owner1State || ''} ${data.owner1Zip || ''}</td>
    ...
    <tr>
      <td><strong>Email:</strong> ${data.owner1Email || ''}</td>
      <td><strong>Email:</strong> ${data.owner2Email || ''}</td>
    </tr>
    <tr>
      <td><strong>% of Ownership:</strong> ${data.owner1Ownership || ''}</td>
      <td><strong>% of Ownership:</strong> ${data.owner2Ownership || ''}</td>
    </tr>
    <tr>
      <td><strong>Date of Birth:</strong> ${data.owner1Dob || ''}</td>
      <td><strong>Date of Birth:</strong> ${data.owner2Dob || ''}</td>
    </tr>
    <tr>
      <td style="padding: 0; border: 1px solid #37008F;">
        <table style="width: 100%; border: none; border-collapse: collapse;">
          <tr>
            <td style="border: none; border-right: 1px solid #37008F; padding: 8px 10px; width: 50%;"><strong>SSN:</strong> ${data.owner1Ssn || ''}</td>
            <td style="border: none; padding: 8px 10px; width: 50%;"><strong>Credit Score:</strong> ${data.owner1Credit || ''}</td>
          </tr>
        </table>
      </td>
      <td style="padding: 0; border: 1px solid #37008F;">
        <table style="width: 100%; border: none; border-collapse: collapse;">
          <tr>
            <td style="border: none; border-right: 1px solid #37008F; padding: 8px 10px; width: 50%;"><strong>SSN#:</strong> ${data.owner2Ssn || ''}</td>
            <td style="border: none; padding: 8px 10px; width: 50%;"><strong>Credit Score:</strong> ${data.owner2Credit || ''}</td>
          </tr>
        </table>
      </td>
    </tr>
  ...
  <div class="section-header">C. FINANCIAL INFORMATION</div>
  <table>
    <tr>
      <td><strong>Amount of Funding Requesting:</strong> ${data.fundingAmount || ''}</td>
      <td><strong>Purpose of Funds:</strong> ${data.purposeOfFunds || ''}</td>
    </tr>
    <tr>
      <td>
        <strong>Existing Advances:</strong>
        <span style="display: inline-block; margin-left: 10px;">
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.existingAdvances === 'Yes' ? '✓' : ''}</span> Yes / No
          <span style="display: inline-block; border: 1px solid #000; width: 14px; height: 14px; text-align: center; vertical-align: middle; margin-left: 10px; margin-right: 3px; line-height: 12px; font-size: 10px;">${data.existingAdvances === 'No' ? '✓' : ''}</span>
        </span>
      </td>
      <td><strong>Outstanding Balances:</strong> ${data.firstPositionBalance || ''}</td>
    </tr>
    <tr>
      <td><strong>Current Advances with:</strong> ${data.firstAdvanceWith || ''}</td>
      <td><strong>Payment:</strong> ${data.firstPayment || ''}</td>
    </tr>
  </table>

  <!-- D. LANDLORD OR MORTGAGE INFORMATION -->
  <div class="section-header">D. LANDLORD OR MORTGAGE INFORMATION</div>
  <table>
    <tr>
      <td style="width: 33.33%;"><strong>Rent / Mortgage Monthly Amount:</strong><br>${data.rentMortgageAmount || ''}</td>
      <td style="width: 33.33%;"><strong>Landlord / Mortgage Contact:</strong><br>${data.landlordContact || ''}</td>
      <td style="width: 33.33%;"><strong>Landlord / Mortgage Number:</strong><br>${data.landlordNumber || ''}</td>
    </tr>
  </table>

  <!-- AUTHORIZATION -->
  <div style="font-size: 10px; color: #000; line-height: 1.1; margin: 20px 0; text-align: justify;">
    By signing below, the Merchant and it's owners / principals: (1) certify that all information and documents submitted in connection with this Application is true, correct and complete; and (2) authorize RidgeCrest Financial Group, LLC and it's affiliates to receive credit reports including credit card processor statements and bank statements, from one or more consumer reporting agencies, such as TransUnion, Experian and Equifax, and from other credit bureaus, banks, creditors and other third parties regarding the Merchant and its owners and principals, to verify any information provided on the Application. You also authorize RidgeCrest Financial Group, LLC, as agent for the Recipients, to transmit this application form, along with any of the foregoing information obtained in connection with this application, to any or all of the Recipients for the foregoing purposes. You also consent to the release, by any creditor or financial institution, of any information relating to any of you, to RidgeCrest Financial Group, LLC, as agent on behalf of the Recipients, and to each of the Recipients, on its own behalf.
  </div>
    ...
    <table style="width: 100%; border: none; border-collapse: collapse;">
      <tr>
        <td style="border: none; vertical-align: top; width: 45%;">
          <!-- Owner 1 Signature Line -->
          <div style="margin-bottom: 15px; display: flex">
            <span style="font-weight: bold; display: flex; align-items: end; width: 150px; margin-right: 10px;">Owner/Principle Signature:</span>
            <div style="display: inline-block; border-bottom: 1px solid #000; width: 300px; vertical-align: top;">
              ${data.owner1Signature ? `
              <img src="${data.owner1Signature}" alt="Owner 1 Signature" style="width: 100px; height: 50px; background-color: #d3d3d3; display: block;" />
              ` : '<div style="width: 100px; height: 50px; background-color: #d3d3d3; display: block;"></div>'}
            </div>
          </div>
          <!-- Print Name and Date -->
          <div style="display: table; width: 100%;">
            <div style="display: table-cell; width: 66%; padding-right: 10px;">
              <span style="font-weight: bold;">Print Name:</span>
              <div style="border-bottom: 1px solid #000; padding: 2px 5px;">${data.owner1PrintName || ''}</div>
            </div>
            <div style="display: table-cell; width: 34%;">
              <span style="font-weight: bold;">Date:</span>
              <div style="border-bottom: 1px solid #000; padding: 2px 5px;">${data.owner1Date || ''}</div>
            </div>
          </div>
        </td>

        <td style="border: none; vertical-align: top; width: 45%;">
          <!-- Owner 2 Signature Line -->
          <div style="margin-bottom: 15px; display: flex;">
            <span style="font-weight: bold; display: flex; align-items: end; width: 150px; margin-right: 10px;">Owner/Principle Signature:</span>
            <div style="display: inline-block; border-bottom: 1px solid #000; width: 300px; vertical-align: top;">
              ${data.owner2Signature ? `
              <img src="${data.owner2Signature}" alt="Owner 2 Signature" style="width: 100px; height: 50px; background-color: #d3d3d3; display: block;" />
              ` : '<div style="width: 100px; height: 50px; background-color: #d3d3d3; display: block;"></div>'}
            </div>
          </div>
          <!-- Print Name and Date -->
          <div style="display: table; width: 100%;">
            <div style="display: table-cell; width: 66%; padding-right: 10px;">
              <span style="font-weight: bold;">Print Name:</span>
              <div style="border-bottom: 1px solid #000; padding: 2px 5px;">${data.owner2PrintName || ''}</div>
            </div>
            <div style="display: table-cell; width: 34%;">
              <span style="font-weight: bold;">Date:</span>
              <div style="border-bottom: 1px solid #000; padding: 2px 5px;">${data.owner2Date || ''}</div>
            </div>
          </div>
        </td>
      </tr>
